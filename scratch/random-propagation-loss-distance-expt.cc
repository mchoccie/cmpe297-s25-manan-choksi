 ...
 */
 ...
 #include "ns3/manans-propagation-loss-model.h"
 ...
 TestProbabilistic (Ptr<LogNormalShadowingDistancePropagationLossModel> model, double distance, unsigned int samples = 100000)
 {
 ...
 int main (int argc, char *argv[])
 {
 ...
 
   {
     ...
     Ptr<LogNormalShadowingDistancePropagationLossModel> randomProp = CreateObject<LogNormalShadowingDistancePropagationLossModel> ();
   ...
   Simulator::Destroy ();
   std::cout << "Simulation complete. Exiting main()." << std::endl;
